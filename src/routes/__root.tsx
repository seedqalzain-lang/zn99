...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "متجر زين" },
      { name: "twitter:description", content: "ppf_نانو سيراميك _عازل حراري _تلميع_تنجيد _اكسيوارات\nلجميع  منتجات وخدمات السيارات" },

      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/uhVbOI3WjZW3tYNcUGjWkdBv04u2/social-images/social-1783649940546-1000439597.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/uhVbOI3WjZW3tYNcUGjWkdBv04u2/social-images/social-1783649940546-1000439597.webp" },
