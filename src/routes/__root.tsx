...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "زين أصل الحماية — علامة عالمية في نانو سيراميك، PPF، عزل حراري، تنجيد وإكسسوارات السيارات الفاخرة." },
      { name: "author", content: "ZAIN" },
      { property: "og:site_name", content: "ZAIN" },
      { property: "og:title", content: "ZAIN — زين أصل الحماية" },
      { property: "og:description", content: "زين أصل الحماية — علامة عالمية في حماية وعناية السيارات." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ZAIN — زين أصل الحماية" },
      { name: "twitter:description", content: "زين أصل الحماية — علامة عالمية في حماية وعناية السيارات." },
    ],
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/__l5e/assets-v1/8a480b10-0c8e-47b8-b89b-bde1e2cd54c8/zain-logo.png" },
    ],
  }),
